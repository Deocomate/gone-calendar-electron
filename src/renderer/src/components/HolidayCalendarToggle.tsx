      ...
      <div className="space-y-1.5">
        ...
        <button
          ...
          className={`w-full p-2 rounded-xl border text-left text-xs transition-all flex items-center justify-between gap-2 cursor-pointer ${
            isVietnamSubscribed
              ? 'bg-rose-500/10 border-rose-500/40 text-slate-200 shadow-xs'
        ...
        >
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span className="text-[10px] text-slate-500 block truncate">Âm lịch & Dương lịch</span>
            </div>
          </div>
          ...
          <div className="shrink-0 flex items-center">
            {loadingType === 'vietnam' ? (
              ...
              <span className="px-1.5 py-0.5 rounded bg-rose-500/20 text-rose-300 text-[10px] font-semibold flex items-center gap-1">
                <Check className="h-3 w-3" /> Đã thêm
              </span>
            ) : (
              <span className="text-[10px] text-slate-500 hover:text-slate-300">+ Thêm</span>
            )}
          </div>
        </button>
        ...
        <button
          ...
          className={`w-full p-2 rounded-xl border text-left text-xs transition-all flex items-center justify-between gap-2 cursor-pointer ${
            isInternationalSubscribed
              ? 'bg-sky-500/10 border-sky-500/40 text-slate-200 shadow-xs'
              : 'bg-slate-900/60 border-slate-800 text-slate-400 hover:text-slate-200 hover:bg-slate-800/40'
          }`}
        >
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span className="text-[10px] text-slate-500 block truncate">Global celebrations</span>
            </div>
          </div>
          ...
          <div className="shrink-0 flex items-center">
            {loadingType === 'international' ? (
              ...
              <span className="px-1.5 py-0.5 rounded bg-sky-500/20 text-sky-300 text-[10px] font-semibold flex items-center gap-1">
                <Check className="h-3 w-3" /> Đã thêm
              </span>
            ) : (
              <span className="text-[10px] text-slate-500 hover:text-slate-300">+ Thêm</span>
